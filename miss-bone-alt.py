...
while(i < il):
 ...
 geturls_text = geturls_opener.open("http://www.cute-factor.com/imlister.php?cid=missbone&type=e&pp=49&page="+str(i));
 ...
 regex_text = re.escape("<img alt='Miss Bone Emoticons ")+"([0-9]+)"+re.escape("' src=\"")+"(.*?)"+re.escape("\" border=0>");
 ...
 while(isub < ilsub):
  ...
  getsub2xurls_opener.addheaders = [("Referer", "http://www.cute-factor.com/imlister.php?cid=missbone&type=e&pp=49&page="+str(i)), ("User-Agent", fakeua), ("Accept-Encoding", "gzip, deflate"), ("Accept-Language", "en-US,en-CA,en-GB,en-UK,en-AU,en-NZ,en-ZA,en;q=0.5"), ("Accept-Charset", "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7"), ("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"), ("Connection", "close")];
  ...
  gif_file_name = os.path.basename(urlparse.urlparse(post_text[isub][1]).path);
  print(str(i)+","+str(isub+1)+" Finished Downloading Image: "+post_text[isub][1]);
