...
parser.add_argument("-r", "--referer", default="http://motherless.com/",
                    help="specify a custom referer, use if the video access")
parser.add_argument("-g", "--get-url", action="store_true",
                    help="simulate, quiet but print URL")
parser.add_argument("-p", "--get-pageurl", action="store_true",
                    help="simulate, quiet but print URL")
parser.add_argument("-e", "--get-title", action="store_true",
                    help="simulate, quiet but print title")
parser.add_argument("-i", "--get-id", action="store_true",
                    help="simulate, quiet but print id")
parser.add_argument("-t", "--get-thumbnail", action="store_true",
                    help="simulate, quiet but print thumbnail URL")
parser.add_argument("-f", "--get-filename", action="store_true",
                    help="simulate, quiet but print output filename")
parser.add_argument("-u", "--get-username", action="store_true",
                    help="simulate, quiet but print uploaders username")
parser.add_argument("-i", "--get-views", action="store_true",
                    help="simulate, quiet but print number of views")
parser.add_argument("-f", "--get-favorites", action="store_true",
