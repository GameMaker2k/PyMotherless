...
parser.add_argument("--port", "--port-number", default=8080,
    ...
    def default(self, *args, **kwargs):
        ...
        if (pymotherlessinfo['motherlessinfo'] == "gallery"):
            ...
            try:
                ...
                getpage = 1
            getpyurlinfo = pymotherless.get_motherless_galleries_links(
        ...
        if (pymotherlessinfo['motherlessinfo'] == "group"):
            ...
            try:
                ...
                getpage = 1
            getpyurlinfo = pymotherless.get_motherless_groups(
                getpymotherless, geturls_headers, geturls_cj, page=getpage)
            counti = 0
            maxi = getpyurlinfo['numoflinks']
            while (counti < maxi):
        ...
        if (pymotherlessinfo['motherlessinfo'] == "member"):
            ...
            try:
                ...
                getpage = 1
            getpyurlinfo = pymotherless.get_motherless_search_members(
                getpymotherless, geturls_headers, geturls_cj, page=getpage)
            counti = 0
            maxi = getpyurlinfo['numoflinks']
            while (counti < maxi):
