...
tmpfileprefix = "py" + \
    str(sys.version_info[0]) + "motherless" + str(__version_info__[0]) + "-"
tmpfilesuffix = "-"
...
geturls_ua_pymotherless_python = "Mozilla/5.0 (compatible; {proname}/{prover}; +{prourl})".format(
    proname=__project__, prover=__version__, prourl=__project_url__)
if (platform.python_implementation() != ""):
    geturls_ua_pymotherless_python_alt = "Mozilla/5.0 ({osver}; {archtype}; +{prourl}) {pyimp}/{pyver} (KHTML, like Gecko) {proname}/{prover}".format(
...
geturls_headers_firefox_windows7 = {
    ...
    'User-Agent': geturls_ua_firefox_windows7,
...
geturls_headers_seamonkey_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_seamonkey_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_chrome_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_chrome_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_chromium_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_chromium_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_palemoon_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_palemoon_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_opera_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_opera_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_vivaldi_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_vivaldi_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_internet_explorer_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_internet_explorer_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_microsoft_edge_windows7 = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_microsoft_edge_windows7,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_pymotherless_python = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_pymotherless_python,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
...
geturls_headers_pymotherless_python_alt = {
    'Referer': "http://motherless.com/",
    'User-Agent': geturls_ua_pymotherless_python_alt,
    'Accept-Encoding': "gzip, deflate",
    'Accept-Language': "en-US,en;q=0.8,en-CA,en-GB;q=0.6",
    'Accept-Charset': "ISO-8859-1,ISO-8859-15,utf-8;q=0.7,*;q=0.7",
    'Accept': "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
    ...
    for unit in units:
        if abs(bytes) < unitsize:
            ...
            return_val = {
                ...
                'ReadableSuffix': alt_return_val[1]}
            return return_val
        bytes /= unitsize
...
def get_readable_size_from_file(
        infile,
        precision=1,
        unit="IEC",
        usehashes=False,
...
def get_readable_size_from_string(
        instring,
        precision=1,
        unit="IEC",
        usehashes=False,
...
def make_http_headers_from_dict_to_pycurl(
    headers={
        'Referer': "http://motherless.com/",
        'User-Agent': geturls_ua,
        'Accept-Encoding': "gzip, deflate",
...
def make_http_headers_from_list_to_dict(
    headers=[
        ("Referer",
         "http://motherless.com/"),
        ("User-Agent",
...
def download_from_url(
    ...
    if (httplibuse == "urllib"):
        returnval = download_from_url_with_urllib(
            httpurl, httpheaders, httpcookie, sleep)
...
def download_from_url_file(
    ...
    if (httplibuse == "urllib"):
        returnval = download_from_url_file_with_urllib(
            httpurl, httpheaders, httpcookie, buffersize, sleep)
    elif (httplibuse == "requests"):
...
def download_from_url_to_file(
    ...
    if (httplibuse == "urllib"):
        returnval = download_from_url_to_file_with_urllib(
            httpurl, httpheaders, httpcookie, outfile, outpath, buffersize, sleep)
    elif (httplibuse == "requests"):
...
def download_from_url_with_urllib(httpurl, httpheaders, httpcookie, sleep=-1):
    ...
    returnval = {
        ...
        'Headers': dict(
            geturls_text.info()),
        'URL': geturls_text.geturl(),
        'Code': geturls_text.getcode()}
    geturls_text.close()
    return returnval


def download_from_url_file_with_urllib(
        httpurl,
        httpheaders,
        httpcookie,
        buffersize=defbuffersize,
    ...
    with tempfile.NamedTemporaryFile('wb+', prefix=tmpfileprefix, suffix=newtmpfilesuffix, delete=False) as f:
        ...
        returnval = {
            ...
            'FilesizeAlt': {
                'IEC': get_readable_size(
                    downloadsize,
                    2,
                    "IEC"),
                'SI': get_readable_size(
                    downloadsize,
                    2,
                    "SI")},
            'Headers': dict(
            ...
            if (downloadsize > 0):
                percentage = str(
                    "{0:.2f}".format(
                        float(
                            float(
                                fulldatasize / downloadsize) * 100))).rstrip('0').rstrip('.') + "%"
    ...
    returnval.update({'Filesize': os.path.getsize(tmpfilename),
                      'DownloadTime': float(exec_time_start - exec_time_end),
                      'DownloadTimeReadable': hms_string(exec_time_start - exec_time_end)})
    return returnval
...
def download_from_url_to_file_with_urllib(
    ...
    if (not outfile == "-"):
        ...
        pretmpfilename = download_from_url_file_with_urllib(
            httpurl, httpheaders, httpcookie, buffersize[0], sleep)
        ...
        returnval = {
            ...
            'FilesizeAlt': {
                ...
                'SI': get_readable_size(
                    ...
                    2,
                    "SI")},
            'DownloadTime': pretmpfilename['DownloadTime'],
            'DownloadTimeReadable': pretmpfilename['DownloadTimeReadable'],
            'MoveFileTime': float(
                exec_time_start -
                exec_time_end),
            'MoveFileTimeReadable': hms_string(
                exec_time_start -
                exec_time_end),
            'Headers': pretmpfilename['Headers'],
            'URL': pretmpfilename['URL'],
            'Code': pretmpfilename['Code']}
...
if (haverequests):
    def download_from_url_with_requests(
            httpurl, httpheaders, httpcookie, sleep=-1):
        global geturls_download_sleep
        if (sleep < 0):
            sleep = geturls_download_sleep
        ...
        time.sleep(sleep)
        geturls_text = requests.get(
            httpurl, headers=httpheaders, cookies=httpcookie)
        log.info("Downloading URL " + httpurl)
        if (geturls_text.headers.get('Content-Type') ==
                "gzip" or geturls_text.headers.get('Content-Type') == "deflate"):
            if (sys.version[0] == "2"):
        ...
        if (geturls_text.headers.get('Content-Type') !=
                "gzip" and geturls_text.headers.get('Content-Type') != "deflate"):
            returnval_content = geturls_text.content[:]
        returnval = {
            'Type': "Content",
            'Content': returnval_content,
            'Headers': dict(
                geturls_text.headers),
            'URL': geturls_text.url,
            'Code': geturls_text.status_code}
        geturls_text.close()
        return returnval
        ...
        with tempfile.NamedTemporaryFile('wb+', prefix=tmpfileprefix, suffix=newtmpfilesuffix, delete=False) as f:
            ...
            returnval = {
                'Type': "File", 'Filename': tmpfilename, 'Filesize': downloadsize, 'FilesizeAlt': {
                    'IEC': get_readable_size(
                        downloadsize, 2, "IEC"), 'SI': get_readable_size(
                        downloadsize, 2, "SI")}, 'Headers': dict(
                    geturls_text.headers), 'URL': geturls_text.url, 'Code': geturls_text.status_code}
...
if (haverequests):
    def download_from_url_to_file_with_requests(
            httpurl,
            httpheaders,
            httpcookie,
            outfile="-",
...
if (haverequests == False):
    def download_from_url_to_file_with_requests(
            ...
            sleep=-1):
        returnval = download_from_url_to_file_with_urllib(
            httpurl, httpheaders, httpcookie, buffersize, outfile, outpath, sleep)
        return returnval

if (havemechanize):
    def download_from_url_with_mechanize(
            httpurl, httpheaders, httpcookie, sleep=-1):
        global geturls_download_sleep
        if (sleep < 0):
            sleep = geturls_download_sleep
...
if (havemechanize):
    def download_from_url_file_with_mechanize(
            httpurl,
            httpheaders,
            httpcookie,
            buffersize=defbuffersize,
            ...
            returnval = {
                'Type': "File", 'Filename': tmpfilename, 'Filesize': downloadsize, 'FilesizeAlt': {
                    'IEC': get_readable_size(
                        downloadsize, 2, "IEC"), 'SI': get_readable_size(
                        downloadsize, 2, "SI")}, 'Headers': dict(
                    geturls_text.info()), 'URL': geturls_text.geturl(), 'Code': geturls_text.code}
            while True:
                databytes = geturls_text.read(buffersize)
                if not databytes:
                    break
...
if (havemechanize):
    def download_from_url_to_file_with_mechanize(
            httpurl,
            httpheaders,
            httpcookie,
            outfile="-",
...
def check_motherless_url(httpurl):
    ...
    if (urlparts.netloc == "motherless.com" or urlparts.netloc == "www.motherless.com"):
        ...
        urlservtype = "www"
    if (urlparts.netloc == "cdn-avatars.motherlessmedia.com" or urlparts.netloc == "cdn1-avatars.motherlessmedia.com" or urlparts.netloc == "cdn2-avatars.motherlessmedia.com" or urlparts.netloc ==
            "cdn3-avatars.motherlessmedia.com" or urlparts.netloc == "cdn4-avatars.motherlessmedia.com" or urlparts.netloc == "cdn5-avatars.motherlessmedia.com"):
        urltype = "motherless-avatar"
        domaintype = "motherlessmedia"
    if (urlparts.netloc == "cdn-images.motherlessmedia.com" or urlparts.netloc == "cdn1-images.motherlessmedia.com" or urlparts.netloc == "cdn2-images.motherlessmedia.com" or urlparts.netloc ==
            "cdn3-images.motherlessmedia.com" or urlparts.netloc == "cdn4-images.motherlessmedia.com" or urlparts.netloc == "cdn5-images.motherlessmedia.com"):
        urltype = "motherless-image"
        domaintype = "motherlessmedia"
    if (urlparts.netloc == "cdn-videos.motherlessmedia.com" or urlparts.netloc == "cdn1-videos.motherlessmedia.com" or urlparts.netloc == "cdn2-videos.motherlessmedia.com" or urlparts.netloc ==
            "cdn3-videos.motherlessmedia.com" or urlparts.netloc == "cdn4-videos.motherlessmedia.com" or urlparts.netloc == "cdn5-videos.motherlessmedia.com"):
        urltype = "motherless-video"
        domaintype = "motherlessmedia"
    if (urlparts.netloc == "cdn-thumbs.motherlessmedia.com" or urlparts.netloc == "cdn1-thumbs.motherlessmedia.com" or urlparts.netloc == "cdn2-thumbs.motherlessmedia.com" or urlparts.netloc ==
            "cdn3-thumbs.motherlessmedia.com" or urlparts.netloc == "cdn4-thumbs.motherlessmedia.com" or urlparts.netloc == "cdn5-thumbs.motherlessmedia.com"):
        urltype = "motherless-thumbnail"
        domaintype = "motherlessmedia"
    if (urlparts.netloc == "cdn-avatars.motherlessmedia.com" or urlparts.netloc == "cdn-images.motherlessmedia.com" or urlparts.netloc ==
            "cdn-videos.motherlessmedia.com" or urlparts.netloc == "cdn-thumbs.motherlessmedia.com"):
        urlservtype = "cdn"
    if (urlparts.netloc == "cdn1-avatars.motherlessmedia.com" or urlparts.netloc == "cdn1-images.motherlessmedia.com" or urlparts.netloc ==
            "cdn1-videos.motherlessmedia.com" or urlparts.netloc == "cdn1-thumbs.motherlessmedia.com"):
        urlservtype = "cdn1"
    if (urlparts.netloc == "cdn2-avatars.motherlessmedia.com" or urlparts.netloc == "cdn2-images.motherlessmedia.com" or urlparts.netloc ==
            "cdn2-videos.motherlessmedia.com" or urlparts.netloc == "cdn2-thumbs.motherlessmedia.com"):
        urlservtype = "cdn2"
    if (urlparts.netloc == "cdn3-avatars.motherlessmedia.com" or urlparts.netloc == "cdn3-images.motherlessmedia.com" or urlparts.netloc ==
            "cdn3-videos.motherlessmedia.com" or urlparts.netloc == "cdn3-thumbs.motherlessmedia.com"):
        urlservtype = "cdn3"
    if (urlparts.netloc == "cdn4-avatars.motherlessmedia.com" or urlparts.netloc == "cdn4-images.motherlessmedia.com" or urlparts.netloc ==
            "cdn4-videos.motherlessmedia.com" or urlparts.netloc == "cdn4-thumbs.motherlessmedia.com"):
        urlservtype = "cdn4"
    if (urlparts.netloc == "cdn5-avatars.motherlessmedia.com" or urlparts.netloc == "cdn5-images.motherlessmedia.com" or urlparts.netloc ==
            "cdn5-videos.motherlessmedia.com" or urlparts.netloc == "cdn5-thumbs.motherlessmedia.com"):
        urlservtype = "cdn5"
    if (urltype is None or domaintype is None or urlservtype is None):
        return False
    returnval.update({'url': urlparts.geturl(),
                      'originalurl': httpurl,
                      'urltype': urltype,
                      'urlserv': urlservtype,
...
def get_motherless_link_type(httpurl):
    ...
    returnval = False
    if (mlessvidid[1] == "videos" and len(mlessvidid) == 3 and (mlessvidid[2] == "recent" or mlessvidid[2] ==
                                                                "favorited" or mlessvidid[2] == "viewed" or mlessvidid[2] == "commented" or mlessvidid[2] == "popular")):
        returnval = "gallery"
    if (mlessvidid[1] == "images" and len(mlessvidid) == 3 and (mlessvidid[2] == "recent" or mlessvidid[2] ==
                                                                "favorited" or mlessvidid[2] == "viewed" or mlessvidid[2] == "commented" or mlessvidid[2] == "popular")):
        returnval = "gallery"
    if (mlessvidid[1] == "galleries" and len(mlessvidid) == 3 and (mlessvidid[2] == "recent" or mlessvidid[2] ==
                                                                   "favorited" or mlessvidid[2] == "viewed" or mlessvidid[2] == "commented" or mlessvidid[2] == "popular")):
        returnval = "gallery"
    ...
    if (mlessvidid[1] == "groups" and len(mlessvidid) == 2):
        returnval = "group"
    if (mlessvidid[1] == "groups" and len(mlessvidid)
            == 3 and mlessvidid[2] == "search"):
        returnval = "group"
    if (mlessvidid[1] == "groups" and len(mlessvidid)
            == 4 and mlessvidid[2] == "category"):
        returnval = "group"
    if (mlessvidid[1] == "live" and len(mlessvidid) == 3 and (
            mlessvidid[2] == "videos" or mlessvidid[2] == "images")):
        returnval = "gallery"
    if (mlessvidid[1] == "u" and len(mlessvidid) == 3):
        returnval = "gallery"
    if (mlessvidid[1] == "f" and len(mlessvidid) == 4 and (mlessvidid[2] ==
                                                           "videos" or mlessvidid[2] == "images" or mlessvidid[2] == "galleries")):
        returnval = "gallery"
    if (mlessvidid[1] == "galleries" and len(
            mlessvidid) == 4 and mlessvidid[2] == "member"):
        returnval = "gallery"
    if (mlessvidid[1] == "galleries" and len(mlessvidid) == 5 and mlessvidid[2] == "member" and (
            mlessvidid[4] == "created" or mlessvidid[4] == "viewed" or mlessvidid[4] == "favorited" or mlessvidid[4] == "commented")):
        returnval = "gallery"
    ...
    if (mlessvidid[1] == "gm" and len(mlessvidid) == 3):
        returnval = "member"
    if (mlessvidid[1] == "term" and len(mlessvidid) == 3 and (
            mlessvidid[2] == "videos" or mlessvidid[2] == "images" or mlessvidid[2] == "galleries")):
        returnval = "gallery"
    if (mlessvidid[1] == "g" and len(mlessvidid) ==
            4 and re.match("^([0-9A-F]+)$", mlessvidid[3])):
        returnval = "link"
    if (mlessvidid[1] == "random" and len(mlessvidid) == 3 and (
            mlessvidid[2] == "video" or mlessvidid[2] == "image")):
        returnval = "link"
    ...
    if (re.match("^G", mlessvidid[1]) and len(mlessvidid) == 3):
        returnval = "link"
    if (re.match("^g", mlessvidid[1]) and len(
            mlessvidid) == 4 and re.match("^([0-9A-F]+)$", mlessvidid[3])):
        returnval = "link"
    if (mlessvidid[1] == "members" and len(mlessvidid) == 2):
        returnval = "member"
    if (mlessvidid[1] == "members" and len(mlessvidid)
            == 3 and mlessvidid[2] == "search"):
        returnval = "member"
    if (mlessvidid[1] == "members" and len(mlessvidid) == 4 and (mlessvidid[2] == "uploader" or mlessvidid[2] == "viewed" or mlessvidid[2] ==
                                                                 "social" or mlessvidid[2] == "favorited" or mlessvidid[2] == "commented" or mlessvidid[2] == "mentioned" or mlessvidid[2] == "verified")):
        returnval = "member"
    ...
    if (mlessvidid[1] == "about" and len(mlessvidid) == 2):
        returnval = "team"
    if (mlessvidid_parts.netloc == "cdn-images.motherlessmedia.com" or mlessvidid_parts.netloc ==
            "cdn-videos.motherlessmedia.com" or mlessvidid_parts.netloc == "cdn-thumbs.motherlessmedia.com"):
        returnval = "download"
    if (mlessvidid_parts.netloc == "cdn1-images.motherlessmedia.com" or mlessvidid_parts.netloc ==
            "cdn1-videos.motherlessmedia.com" or mlessvidid_parts.netloc == "cdn1-thumbs.motherlessmedia.com"):
        returnval = "download"
    if (mlessvidid_parts.netloc == "cdn2-images.motherlessmedia.com" or mlessvidid_parts.netloc ==
            "cdn2-videos.motherlessmedia.com" or mlessvidid_parts.netloc == "cdn2-thumbs.motherlessmedia.com"):
        returnval = "download"
    if (mlessvidid_parts.netloc == "cdn3-images.motherlessmedia.com" or mlessvidid_parts.netloc ==
            "cdn3-videos.motherlessmedia.com" or mlessvidid_parts.netloc == "cdn3-thumbs.motherlessmedia.com"):
        returnval = "download"
    if (mlessvidid_parts.netloc == "cdn4-images.motherlessmedia.com" or mlessvidid_parts.netloc ==
            "cdn4-videos.motherlessmedia.com" or mlessvidid_parts.netloc == "cdn4-thumbs.motherlessmedia.com"):
        returnval = "download"
    if (mlessvidid_parts.netloc == "cdn5-images.motherlessmedia.com" or mlessvidid_parts.netloc ==
            "cdn5-videos.motherlessmedia.com" or mlessvidid_parts.netloc == "cdn5-thumbs.motherlessmedia.com"):
        returnval = "download"
    if (returnval == False and len(mlessvidid) ==
            2 and re.match("^([0-9A-F]+)$", mlessvidid[1])):
        returnval = "link"
    return returnval
...
def get_motherless_link_type_alt(httpurl):
    httpurl = fix_motherless_url(httpurl)
    returnval = {'urlinfo': check_motherless_url(
        httpurl), 'motherlessinfo': get_motherless_link_type(httpurl)}
    return returnval


def get_motherless_number_of_pages(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib"):
    ...
    mregex_getpagenum = re.escape("\" class=\"pop\" rel=\"") + \
        '?\'?([^"\'>]*)' + re.escape("\">") + "([0-9]+)" + re.escape("</a>")
...
def get_motherless_user_info(username, motherless_serv=None):
    ...
    avatarfilenameext = os.path.basename(
        urlparse.urljoin(
            "http://" +
            motherless_subdomain +
    ...
    returnval.update({'avatarurl': "http://" + motherless_subdomain +
                     "avatars.motherlessmedia.com/thumbs/" + username + "-avatar.jpg"})
...
def get_motherless_links(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib",
        motherless_serv=None):
    httpurl = fix_motherless_url(httpurl)
    ...
    mregex_geturlone = re.escape("__fileurl = '") + \
        '?\'?([^"\'>]*)' + re.escape("';")
    mlesslinkone = re.findall(mregex_geturlone, mrtext)
    mregex_geturlonetype = re.escape("https://") + "cdn([1-5]+)\\-" + "(images|videos)" + re.escape(
        ".motherlessmedia.com/") + "(images|videos)" + re.escape("/") + "([\\w\\/\\?\\&\\=\\.\\-]+)"
    mlesslinkonetype = re.findall(mregex_geturlonetype, mrtext)
    mregex_geturltwo = re.escape(
        "<meta property=\"og:image\" content=\"") + '?\'?([^"\'>]*)' + re.escape("\">")
    mlesslinktwo = re.findall(mregex_geturltwo, mrtext)
    mregex_geturltwotype = re.escape("https://") + "cdn([1-5]+)\\-" + "(images|thumbs)" + re.escape(
        ".motherlessmedia.com/") + "(images|thumbs)" + re.escape("/") + "([\\w\\/\\?\\&\\=\\.\\-]+)"
    mlesslinktwotype = re.findall(mregex_geturltwotype, mrtext)
    filenameext = os.path.basename(urlparse.urljoin(
        mlesslinkone[0], urlparse.urlparse(mlesslinkone[0]).path))
    filename, fileextension = os.path.splitext(filenameext)
    thumbfilenameext = os.path.basename(urlparse.urljoin(
        mlesslinktwo[0], urlparse.urlparse(mlesslinktwo[0]).path))
    thumbfilename, thumbfileextension = os.path.splitext(thumbfilenameext)
    mregex_getuname = re.escape("<tr rel=\"") + \
        '?\'?([^"\'>]*)' + re.escape("\"")
    ...
    if (mlesslinkonetype[0][2] == "images"):
        ...
        thumbnailalt = "http://cdn" + \
            mlesslinktwotype[0][0] + \
            "-thumbs.motherlessmedia.com/thumbs/" + thumbnailaltpart
        thumbnailaltfilenameext = os.path.basename(urlparse.urljoin(
            thumbnailalt, urlparse.urlparse(thumbnailalt).path))
        thumbnailaltfilename, thumbnailaltfileextension = os.path.splitext(
            thumbnailaltfilenameext)
    if (mlesslinkonetype[0][2] == "videos"):
        ...
        stripimg = "http://cdn" + \
            mlesslinktwotype[0][0] + \
            "-thumbs.motherlessmedia.com/thumbs/" + stripimgpart
        stripimgfilenameext = os.path.basename(
            urlparse.urljoin(stripimg, urlparse.urlparse(stripimg).path))
        stripimgfilename, stripimgfileextension = os.path.splitext(
            stripimgfilenameext)
    returnval = False
    mlessurltype = get_motherless_link_type(mlesslinkone[0])
    if (mlesslinkonetype[0][2] == "images"):
        regex_getimgsize = re.escape("style=\"width: ") + "([0-9]+)" + re.escape(
            "px; height: ") + "([0-9]+)" + re.escape("px;\"")
        mlessgetimgsize = re.findall(regex_getimgsize, mrtext)
        returnval = {
            'type': mlesslinkonetype[0][2],
            ...
            'thumbnail': mlesslinktwo[0].replace(
                "images",
                "thumbs"),
            'thumbnailalt': thumbnailalt + "?from_helper",
            'title': mlesstitle[0],
            ...
            'numberofviews': int(
                mlessviews[0][1].replace(
                    ',',
                    '')),
            'numberoffavorites': int(
                mlessfavorited[0][1].replace(
                    ',',
                    ''))}
    if (mlesslinkonetype[0][2] == "videos"):
        returnval = {
            ...
            'orginurl': httpurl,
            'orginurltype': get_motherless_link_type(httpurl),
            'thumbnail': thumbnailalt + "?from_helper",
            'thumbnailalt': mlesslinktwo[0].replace(
                "images",
                "thumbs"),
            'strip': stripimg + "?from_helper",
            'title': mlesstitle[0],
            'fullfilename': filenameext,
            'filename': filename,
            'extension': fileextension,
            'thumbfullfilename': thumbnailaltpart,
            'thumbfilename': thumbnailaltfilename,
            'thumbextension': thumbnailaltfileextension,
            'thumbnailaltfullfilename': thumbfilenameext,
            'thumbnailaltfilename': thumbfilename,
            'thumbnailaltextension': thumbfileextension,
            'stripfullfilename': stripimgfilenameext,
            'stripfilename': stripimgfilename,
            'stripextension': stripimgfileextension,
            'userinfo': get_motherless_user_info(mlessuname),
            'username': mlessuname,
            'avatarurl': mlessavatar,
            'avatarfullfilename': avatarfilenameext,
...
def get_motherless_links_from_url(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib"):
    ...
    if (get_motherless_link_type(httpurl) == "download"):
        ...
        if (filewithext[0] == "/images"):
            ...
            returnval = get_motherless_links(
                "http://motherless.com/" +
                filewithoutext,
                httpheaders,
                httpcookie,
...
def get_motherless_external_links(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib"):
    httpurl = fix_motherless_url(httpurl)
    if (get_motherless_link_type(httpurl) !=
            "board" and get_motherless_link_type(httpurl) != "link"):
        returnval = False
        return returnval
    premrtext = download_from_url(httpurl, httpheaders, httpcookie, httplibuse)
    mrtext = premrtext['Content']
    if (sys.version[0] >= "3"):
        mrtext = mrtext.decode('ascii', 'replace')
    mregex_geturlinternal = re.escape("<a href=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" rev=\"outbound\" rel=\"nofollow\" class=\"pop\" target=\"_blank\" title=\"motherless link\">")
    mlesslinkinternal = re.findall(mregex_geturlinternal, mrtext)
    mregex_geturlexternal = re.escape("<a href=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" rev=\"outbound\" rel=\"nofollow\" class=\"pop\" target=\"_blank\" title=\"external link\">")
    ...
    if (len(mlesslinkinternal) > 1):
        ...
        while (mli < mlil):
            ...
            returnvalone.update(
                {mli: {'urltype': mlessurltype, 'url': mlesslinkinternal[mli]}})
            mli = mli + 1
    returnvaltwo = None
    if (len(mlesslinkexternal) > 1):
        ...
        while (mli < mlil):
            returnvaltwo.update(
                {mli: {'urltype': "external", 'url': mlesslinkexternal[mli]}})
            mli = mli + 1
    if (returnvalone is None and returnvaltwo is None):
        returnval = {'internal': None, 'external': None}
    if (returnvalone is not None and returnvaltwo is not None):
        returnval = {'internal': returnvalone, 'external': returnvaltwo}
    if (returnvalone is not None and returnvaltwo is None):
        returnval = {'internal': returnvalone, 'external': None}
    if (returnvalone is None and returnvaltwo is not None):
        returnval = {'internal': None, 'external': returnvaltwo}
    return returnval


def get_motherless_galleries_links(
    httpurl, httpheaders, httpcookie, httplibuse="urllib", page=1, getlinks=[
        0, -1], motherless_serv=None):
    httpurl = fix_motherless_url(httpurl)
    ...
    if (sys.version[0] >= "3"):
        mrtext = mrtext.decode('ascii', 'replace')
    mregex_geturlone = re.escape(
        "<a href=\"") + '?\'?([^"\'>]*)' + re.escape("\" class=\"img-container\" target=\"_self\">")
    ...
    mregex_geturltwo = re.escape("<img class=\"static\" src=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" data-strip-src=\"") + '?\'?([^"\'>]*)' + re.escape("\" alt=\"") + '?\'?([^">]*)' + re.escape("\" />")
    mlesslinktwo = re.findall(mregex_geturltwo, mrtext)
    mregex_getcaption = re.escape(
        "<h2 class=\"caption title\">") + "(.*)" + re.escape("</h2>")
    mlesscaption = re.findall(mregex_getcaption, mrtext)
    mregex_gethits = re.escape(
        "<div class=\"caption right\">") + "([0-9\\,]+)" + re.escape(" Hits</div>")
    mlesshits = re.findall(mregex_gethits, mrtext)
    if (len(mlesshits) < 1):
        mregex_gethits = re.escape(
            "<div class=\"caption right\">\n        ") + "([0-9\\,]+)" + re.escape(" Hits\n    </div>")
        mlesshits = re.findall(mregex_gethits, mrtext)
    mregex_getuserinfo = re.escape(
        "<a class=\"caption left\" href=\"") + '?\'?([^"\'>]*)' + re.escape("\">")
    mlessuname = re.findall(mregex_getuserinfo, mrtext)
    mregex_getmediainfo = re.escape("data-size=\"") + '?\'?([^"\'>]*)' + re.escape("\" ") + re.escape("data-is-premium=\"") + '?\'?([^"\'>]*)' + re.escape("\" ") + re.escape("data-codename=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" ") + re.escape("data-mediatype=\"") + '?\'?([^"\'>]*)' + re.escape("\" ") + re.escape("data-gallery-codename=\"") + '?\'?([^"\'>]*)' + re.escape("\" ") + re.escape("data-frames=\"") + '?\'?([^"\'>]*)' + re.escape("\">")
    ...
    while (mli < mlil):
        ...
        stripfilenameext = os.path.basename(
            urlparse.urljoin(
                mlesslinktwo[mli][1],
                urlparse.urlparse(
                    mlesslinktwo[mli][1]).path))
        stripfilename, stripfileextension = os.path.splitext(stripfilenameext)
        thumbfilenameext = os.path.basename(
            urlparse.urljoin(
                mlesslinktwo[mli][0],
                urlparse.urlparse(
                    mlesslinktwo[mli][0]).path))
        thumbfilename, thumbfileextension = os.path.splitext(thumbfilenameext)
        mlessurltype = get_motherless_link_type(
            "http://motherless.com/" + mlesslinkone[mli])
        avatarfilenameext = os.path.basename(
            urlparse.urljoin(
                "http://" +
                motherless_subdomain +
                ...
                urlparse.urlparse(
                    ...
                    mlessuname[mli] +
                    "-avatar.jpg").path))
        avatarfilename, avatarfileextension = os.path.splitext(
            avatarfilenameext)
            ...
            returnval.update(
                {
                    mli: {
                        'type': "images",
                        'urltype': mlessurltype,
                        'url': "http://motherless.com" + mlesslinkone[mli],
                        'thumbnail': mlesslinktwo[mli][0],
                        'thumbnailalt': mlesslinktwo[mli][1],
                        'title': mlesslinktwo[mli][2],
                        'thumbfullfilename': thumbfilenameext,
                        'thumbfilename': thumbfilename,
                        'thumbextension': thumbfileextension,
                        'thumbnailaltfullfilename': stripfilenameext,
                        'thumbnailaltfilename': stripfilename,
                        'thumbnailaltextension': stripfileextension,
                        'userinfo': get_motherless_user_info(
                            mlessuname[mli]),
                        'username': mlessuname[mli],
                        'avatarurl': "http://" + motherless_subdomain + "avatars.motherlessmedia.com/thumbs/" + mlessuname[mli] + "-avatar.jpg",
                        'avatarfullfilename': avatarfilenameext,
                        'avatarfilename': avatarfilename,
                        'avatarextension': avatarfileextension,
                        'numberofviews': int(
                            mlesshits[mli].replace(
                                ',',
                                ''))}})
        if (mlessmediainfo[mli][3] == "video"):
            altthumbnail = mlesslinktwo[mli][1].replace('-strip', '')
            altfilenameext = os.path.basename(
                urlparse.urljoin(
                    mlesslinktwo[mli][1],
                    urlparse.urlparse(
                        mlesslinktwo[mli][1]).path))
            ...
            returnval.update(
                {
                    mli: {
                        ...
                        'url': "http://motherless.com" + mlesslinkone[mli],
                        'thumbnail': mlesslinktwo[mli][0],
                        'strip': mlesslinktwo[mli][1],
                        'thumbnailalt': altthumbnail,
                        'title': mlesslinktwo[mli][2],
                        'thumbfullfilename': thumbfilenameext,
                        'thumbfilename': thumbfilename,
                        'thumbextension': thumbfileextension,
                        ...
                        'thumbnailaltfullfilename': altfilenameext,
                        'thumbnailaltfilename': altfilename,
                        'thumbnailaltextension': altfileextension,
                        'userinfo': get_motherless_user_info(
                            mlessuname[mli]),
                        'username': mlessuname[mli],
                        'avatarurl': "http://" + motherless_subdomain + "avatars.motherlessmedia.com/thumbs/" + mlessuname[mli] + "-avatar.jpg",
...
def get_motherless_random_links(
    httpheaders,
    httpcookie,
    httplibuse="urllib",
    linktype="video",
    ...
    if (linktype == "image"):
        ...
        while (mli < mlil):
            get_links = get_motherless_links(
                "http://motherless.com/random/image",
                httpheaders,
                httpcookie,
                httplibuse)
            returnval.update(
                {
                    mli: {
                        'type': "images",
                        'urltype': get_motherless_link_type(
                            "http://motherless.com/" + get_links['filename']),
                        'url': "http://motherless.com/" + get_links['filename'],
                        'thumbnail': get_links['thumbnail'],
                        'strip': get_links['thumbnailalt'],
                        'title': get_links['title'],
                        'thumbfullfilename': get_links['thumbfullfilename'],
                        'thumbfilename': get_links['thumbfilename'],
                        'thumbextension': get_links['thumbextension'],
                        'stripfullfilename': get_links['thumbnailaltfullfilename'],
                        'stripfilename': get_links['thumbnailaltextension'],
                        'stripextension': get_links['thumbnailaltfilename'],
                        'userinfo': get_motherless_user_info(
                            get_links['username']),
                        'username': get_links['username'],
                        'avatarurl': get_links['avatarurl'],
                        'avatarfullfilename': get_links['avatarfullfilename'],
                        'avatarfilename': get_links['avatarfilename'],
                        'avatarextension': get_links['avatarextension']}})
            mli = mli + 1
    if (linktype == "video"):
        returnval = {'pages': 1}
        returnval.update({'curpage': 1})
        ...
        while (mli < mlil):
            get_links = get_motherless_links(
                "http://motherless.com/random/video",
                httpheaders,
                httpcookie,
                httplibuse)
            returnval.update(
...
def get_motherless_random_links_alt(
    httpheaders,
    httpcookie,
    httplibuse="urllib",
    linktype="video",
...
def get_motherless_boards_links(
    httpurl, httpheaders, httpcookie, httplibuse="urllib", geturlinfo=False, getlinks=[
        0, -1], motherless_serv=None):
    httpurl = fix_motherless_url(httpurl)
    ...
    mrtext_tmp = re.sub(re.escape("http://www.motherless.com"), "", mrtext_tmp)
    mregex_geturlone = re.escape(
        "<a href=\"") + '?\'?([^"\'>]*)' + re.escape("\" title=\"motherless link\">")
    mlesslinkone = re.findall(mregex_geturlone, mrtext_tmp)
    mregex_geturlname = re.escape("<a href=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" class=\"post-username special-member op-member\" title=\"op\" rel=\"") + '?\'?([^"\'>]*)' + re.escape("\">")
    mlessurlname = re.findall(mregex_geturlname, mrtext)
    mregex_getdatasrc = re.escape(
        "data-src=\"") + '?\'?([^"\'>]*)' + re.escape("\"")
    ...
    returnval.update({'urltype': mlessrooturltype})
    returnval.update(
        {'userinfo': get_motherless_user_info(mlessurlname[0][1])})
    ...
    while (mli < mlil):
        ...
        if (geturlinfo == False):
            returnval.update({mli: {'urltype': mlessurltype,
                                    'url': "http://motherless.com" + mlesslinkone[mli],
                                    'downloadurl': mlessdatasrc[mli],
                                    'downloadurltype': mlessdlurltype}})
        if (geturlinfo):
            returnval.update({mli: {'urltype': mlessurltype,
                                    'urlinfo': get_motherless_links(httpurl,
                                                                    httpheaders,
                                                                    httpcookie,
                                                                    httplibuse,
                                                                    motherless_serv),
...
def get_motherless_boards_posts(
    httpurl, httpheaders, httpcookie, httplibuse="urllib", getposts=[
        0, -1], motherless_serv=None):
    httpurl = fix_motherless_url(httpurl)
    if (get_motherless_link_type(httpurl) != "board"):
        returnval = False
    ...
    if (sys.version[0] >= "3"):
        mrtext = mrtext.decode('ascii', 'replace')
    mregex_getposts = "(\t+)" + re.escape("<p>") + \
        "(.+?)" + re.escape("</p>") + "(\t+)"
    mlessposts = re.findall(mregex_getposts, mrtext)
    mregex_getuname = re.escape("<a href=\"") + \
        '?\'?([^"\'>]*)' + re.escape("\"")
    mlessuname = re.findall(mregex_getuname, mrtext)
    mregex_getopuname = re.escape("<a href=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" class=\"post-username special-member op-member\" title=\"op\" rel=\"") + '?\'?([^"\'>]*)' + re.escape("\">")
    ...
    returnval.update({'urltype': mlessrooturltype})
    returnval.update(
        {'userinfo': get_motherless_user_info(mlessopuname[0][1])})
    ...
    avatarfilename, avatarfileextension = os.path.splitext(avatarfilenameext)
    returnval.update({'avatarurl': "http://" + motherless_subdomain +
                     "avatars.motherlessmedia.com/thumbs/" + mlessopuname[0][1] + "-avatar.jpg"})
    returnval.update({'avatarfullfilename': avatarfilenameext})
    returnval.update({'avatarfilename': avatarfilename})
    returnval.update({'avatarextension': avatarfileextension})
    while (mli < mlil):
...
def get_motherless_links_comments(
    httpurl, httpheaders, httpcookie, httplibuse="urllib", getposts=[
        0, -1], motherless_serv=None):
    httpurl = fix_motherless_url(httpurl)
    if (get_motherless_link_type(httpurl) != "link"):
    ...
    if (sys.version[0] >= "3"):
        mrtext = mrtext.decode('ascii', 'replace')
    mregex_getposts = re.escape(
        "<div style=\"text-align: justify;\">\n") + "(\t+)(.+?)" + re.escape("</div>")
    mlessposts = re.findall(mregex_getposts, mrtext)
    mregex_getuname = re.escape("<div class=\"media-comment\" id=\"") + \
        '?\'?([^"\'>]*)' + re.escape("\" rel=\"0\" rev=\"") + \
        '?\'?([^"\'>]*)' + re.escape("\">")
    mlessuname = re.findall(mregex_getuname, mrtext)
    mregex_getopuname = re.escape(
        "<tr rel=\"") + '?\'?([^"\'>]*)' + re.escape("\"")
    mlessopuname = re.findall(mregex_getopuname, mrtext)
    if (getposts[1] > len(mlessposts) or getposts[1] == -1):
        getposts[1] = len(mlessposts)
    ...
    avatarfilename, avatarfileextension = os.path.splitext(avatarfilenameext)
    returnval.update({'avatarurl': "http://" + motherless_subdomain +
                     "avatars.motherlessmedia.com/thumbs/" + mlessopuname[0] + "-avatar.jpg"})
    returnval.update({'avatarfullfilename': avatarfilenameext})
    returnval.update({'avatarfilename': avatarfilename})
    returnval.update({'avatarextension': avatarfileextension})
    while (mli < mlil):
        ...
        returnval.update(
            {
                mli: {
                    ...
                    'userinfo': get_motherless_user_info(
                        mlessuname[mli][1]),
                    'username': mlessuname[mli][1],
                    'avatarurl': "http://" + motherless_subdomain + "avatars.motherlessmedia.com/thumbs/" + mlessuname[mli][1] + "-avatar.jpg",
                    'avatarfullfilename': avatarfilenameext,
                    'avatarfilename': avatarfilename,
                    'avatarextension': avatarfileextension}})
        mli = mli + 1
...
def get_motherless_search_members(
    httpurl, httpheaders, httpcookie, httplibuse="urllib", page=1, getlinks=[
        0, -1]):
    httpurl = fix_motherless_url(httpurl)
    ...
    while (mli < mlil):
        avatarfilenameext = os.path.basename(urlparse.urljoin(
            mlessavatar[mli], urlparse.urlparse(mlessavatar[mli]).path))
        avatarfilename, avatarfileextension = os.path.splitext(
            avatarfilenameext)
        mlessurlname[mli] = mlessurlname[mli].replace("/m/", "")
        mlessurltype = get_motherless_link_type(
            "http://motherless.com/" + mlessurlname[mli])
        returnval.update({mli: {'urltype': mlessurltype,
                                'url': "http://motherless.com/" + mlessurlname[mli],
                                'userinfo': get_motherless_user_info(mlessurlname[mli]),
                                'username': mlessuname[mli],
                                'avatarurl': mlessavatar[mli],
                                'avatarfullfilename': avatarfilenameext,
                                'avatarfilename': avatarfilename,
                                'avatarextension': avatarfileextension}})
        mli = mli + 1
...
def get_motherless_girls(httpheaders, httpcookie,
                         httplibuse="urllib", getlinks=[0, -1]):
    premrtext = download_from_url(
        "http://motherless.com/girls", httpheaders, httpcookie, httplibuse)
    mrtext = premrtext['Content']
    if (sys.version[0] >= "3"):
        mrtext = mrtext.decode('ascii', 'replace')
    mregex_getuname = re.escape("<a href=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" rev=\"") + '?\'?([^"\'>]*)' + re.escape("\" rel=\"") + '?\'?([^"\'>]*)' + re.escape("\">")
    mlessuname = re.findall(mregex_getuname, mrtext)
    mregex_geturlname = re.escape(
        "\n\t\t\t\t\t\t<a href=\"") + '?\'?([^"\'>]*)' + re.escape("\" target=\"_blank\">")
    mlessurlname = re.findall(mregex_geturlname, mrtext)
    ...
    returnval.update(
        {'orginurltype': get_motherless_link_type("http://motherless.com/girls")})
    mlessrooturltype = get_motherless_link_type("http://motherless.com/girls")
    returnval.update({'urltype': mlessrooturltype})
    while (mli < mlil):
        avatarfilenameext = os.path.basename(urlparse.urljoin(
            mlessuname[mli][0], urlparse.urlparse(mlessuname[mli][0]).path))
        avatarfilename, avatarfileextension = os.path.splitext(
            avatarfilenameext)
        mlessurltype = get_motherless_link_type(
            "http://motherless.com/" + mlessuname[mli][1])
        returnval.update({mli: {'urltype': mlessurltype,
                                'url': "http://motherless.com/" + mlessuname[mli][1],
                                'userinfo': get_motherless_user_info(mlessuname[mli][1]),
                                'username': mlessuname[mli][1],
                                'avatarurl': mlessuname[mli][0],
                                'avatarfullfilename': avatarfilenameext,
                                'avatarfilename': avatarfilename,
                                'avatarextension': avatarfileextension}})
        mli = mli + 1
...
def get_motherless_team(httpheaders, httpcookie,
                        httplibuse="urllib", getlinks=[0, -1]):
    premrtext = download_from_url(
        "http://motherless.com/about", httpheaders, httpcookie, httplibuse)
    mrtext = premrtext['Content']
    if (sys.version[0] >= "3"):
        mrtext = mrtext.decode('ascii', 'replace')
    mregex_getuname = re.escape(
    ...
    returnval.update(
        {'orginurltype': get_motherless_link_type("http://motherless.com/about")})
    mlessrooturltype = get_motherless_link_type("http://motherless.com/about")
    returnval.update({'urltype': mlessrooturltype})
    while (mli < mlil):
        avatarfilenameext = os.path.basename(urlparse.urljoin(
            mlessavatar[mli][0], urlparse.urlparse(mlessavatar[mli][0]).path))
        avatarfilename, avatarfileextension = os.path.splitext(
            avatarfilenameext)
        mlessuname_odd[mli] = mlessuname_odd[mli].replace("/m/", "")
        mlessuname_even[mli] = mlessuname_even[mli].replace("/m/", "")
        mlessurltype = get_motherless_link_type(
            "http://motherless.com/" + mlessuname_odd[mli])
        returnval.update({mli: {'urltype': mlessurltype,
                                'url': "http://motherless.com/" + mlessuname_odd[mli],
                                'userinfo': get_motherless_user_info(mlessuname_odd[mli]),
                                'username': mlessuname_odd[mli],
                                'avatarurl': mlessavatar[mli][0],
                                'avatarfullfilename': avatarfilenameext,
                                'avatarfilename': avatarfilename,
                                'avatarextension': avatarfileextension}})
        mli = mli + 1
...
def get_motherless_top_referrers(
        httpheaders, httpcookie, httplibuse="urllib", getlinks=[0, -1]):
    premrtext = download_from_url(
        "http://motherless.com/referers", httpheaders, httpcookie, httplibuse)
    mrtext = premrtext['Content']
    if (sys.version[0] >= "3"):
        mrtext = mrtext.decode('ascii', 'replace')
    mregex_geturlname = "([0-9]+)" + re.escape(". <a href=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" class=\"pop\" target=\"_blank\" rel=\"nofollow\">\n						") + "(.*)" + re.escape("					</a>")
    mlessurlname = re.findall(mregex_geturlname, mrtext)
    ...
    returnval.update({'orginurltype': get_motherless_link_type(
        "http://motherless.com/referers")})
    mlessrooturltype = get_motherless_link_type(
        "http://motherless.com/referers")
    returnval.update({'urltype': mlessrooturltype})
    while (mli < mlil):
        returnval.update({mli: {'urltype': "referer-links",
                                'url': mlessurlname[mli][1],
                                'title': mlessurlname[mli][2]}})
        mli = mli + 1
    return returnval


def get_motherless_top_referers(
        httpheaders, httpcookie, httplibuse="urllib", getlinks=[0, -1]):
    return get_motherless_top_referrers(
        httpheaders, httpcookie, httplibuse, getlinks)


def get_motherless_groups(
    httpurl, httpheaders, httpcookie, httplibuse="urllib", page=1, getlinks=[
        0, -1]):
    httpurl = fix_motherless_url(httpurl)
    ...
    mregex_getavatar = re.escape("<img\n        src=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\"\n        class=\"avatar avatar-") + "(full|medium)" + re.escape("\"")
    mlessavatar = re.findall(mregex_getavatar, mrtext)
    mregex_getgroups = re.escape("<a href=\"") + '?\'?([^"\'>]*)' + re.escape(
        "\" class=\"grunge motherless-red\">\n") + "(.*)" + re.escape("</a>")
    ...
    while (mli < mlil):
        thumbfilenameext = os.path.basename(urlparse.urljoin(
            mlessavatar[mli][0], urlparse.urlparse(mlessavatar[mli][0]).path))
        thumbfilename, thumbfileextension = os.path.splitext(thumbfilenameext)
        returnval.update({mli: {'urltype': get_motherless_link_type("http://motherless.com/" + mlessgroups[mli][0]),
                                'url': "http://motherless.com" + mlessgroups[mli][0],
                                'urltype-image': get_motherless_link_type("http://motherless.com/" + mlessgroups[mli][0].replace("/g/",
                                                                                                                                 "/gi/")),
                                'url-image': "http://motherless.com" + mlessgroups[mli][0].replace("/g/",
                                                                                                   "/gi/"),
                                'urltype-video': get_motherless_link_type("http://motherless.com/" + mlessgroups[mli][0].replace("/g/",
                                                                                                                                 "/gv/")),
                                'url-video': "http://motherless.com" + mlessgroups[mli][0].replace("/g/",
                                                                                                   "/gv/"),
                                'urltype-member': get_motherless_link_type("http://motherless.com/" + mlessgroups[mli][0].replace("/g/",
                                                                                                                                  "/gm/")),
                                'url-member': "http://motherless.com" + mlessgroups[mli][0].replace("/g/",
                                                                                                    "/gm/"),
                                'thumbnail': mlessavatar[mli][0],
                                'title': mlessgroups[mli][1].strip(),
                                'thumbfullfilename': thumbfilenameext,
                                'thumbfilename': thumbfilename,
                                'thumbextension': thumbfileextension}})
        mli = mli + 1
...
def get_motherless_sample_links(
        httpheaders,
        httpcookie,
        httplibuse="urllib",
        numoflinks=10,
        urltype="video",
        enablerand=True):
    if (urltype == "video" and enablerand):
        returnval = {'numoflinks': numoflinks,
                     'orginurl': "http://motherless.com/videos",
                     'orginurltype': get_motherless_link_type("http://motherless.com/videos"),
                     'videos': {'recent': get_motherless_galleries_links("http://motherless.com/videos/recent",
                                                                         httpheaders,
                                                                         httpcookie,
                                                                         httplibuse,
                                                                         1,
                                                                         [0,
                                                                          numoflinks]),
                                'favorited': get_motherless_galleries_links("http://motherless.com/videos/favorited",
                                                                            httpheaders,
                                                                            httpcookie,
                                                                            httplibuse,
                                                                            1,
                                                                            [0,
                                                                             numoflinks]),
                                'viewed': get_motherless_galleries_links("http://motherless.com/videos/viewed",
                                                                         httpheaders,
                                                                         httpcookie,
                                                                         httplibuse,
                                                                         1,
                                                                         [0,
                                                                          numoflinks]),
                                'commented': get_motherless_galleries_links("http://motherless.com/videos/commented",
                                                                            httpheaders,
                                                                            httpcookie,
                                                                            httplibuse,
                                                                            1,
                                                                            [0,
                                                                             numoflinks]),
                                'popular': get_motherless_galleries_links("http://motherless.com/videos/popular",
                                                                          httpheaders,
                                                                          httpcookie,
                                                                          httplibuse,
                                                                          1,
                                                                          [0,
                                                                           numoflinks]),
                                'live': get_motherless_galleries_links("http://motherless.com/live/videos",
                                                                       httpheaders,
                                                                       httpcookie,
                                                                       httplibuse,
                                                                       1,
        ...
        returnval = {'numoflinks': numoflinks,
                     ...
                     'videos': {'recent': get_motherless_galleries_links("http://motherless.com/videos/recent",
                                ...
                                'live': get_motherless_galleries_links("http://motherless.com/live/videos",
                                                                       ...
                                                                       [0,
                                                                        numoflinks])}}
    if (urltype == "image" and enablerand):
        returnval = {'numoflinks': numoflinks,
                     'orginurl': "http://motherless.com/images",
                     'orginurltype': get_motherless_link_type("http://motherless.com/images"),
                     'images': {'recent': get_motherless_galleries_links("http://motherless.com/images/recent",
                                                                         httpheaders,
                                                                         httpcookie,
                                                                         httplibuse,
                                                                         1,
                                                                         [0,
                                                                          numoflinks]),
                                'favorited': get_motherless_galleries_links("http://motherless.com/images/favorited",
                                                                            httpheaders,
                                                                            httpcookie,
                                                                            httplibuse,
                                                                            1,
                                                                            [0,
                                                                             numoflinks]),
                                'viewed': get_motherless_galleries_links("http://motherless.com/images/viewed",
                                                                         httpheaders,
                                                                         httpcookie,
                                                                         httplibuse,
                                                                         1,
                                                                         [0,
                                                                          numoflinks]),
                                'commented': get_motherless_galleries_links("http://motherless.com/images/commented",
                                                                            httpheaders,
                                                                            httpcookie,
                                                                            httplibuse,
                                                                            1,
                                                                            [0,
                                                                             numoflinks]),
                                'popular': get_motherless_galleries_links("http://motherless.com/images/popular",
                                                                          httpheaders,
                                                                          httpcookie,
                                                                          httplibuse,
                                                                          1,
                                                                          [0,
                                                                           numoflinks]),
                                'live': get_motherless_galleries_links("http://motherless.com/live/images",
                                                                       httpheaders,
                                                                       httpcookie,
                                                                       httplibuse,
                                                                       1,
    ...
    if (urltype == "gallery"):
        returnval = {'numoflinks': numoflinks,
                     'orginurl': "http://motherless.com/galleries",
                     'orginurltype': get_motherless_link_type("http://motherless.com/galleries"),
                     'galleries': {'updated': get_motherless_galleries_links("http://motherless.com/galleries/updated",
                                                                             httpheaders,
                                                                             httpcookie,
                                                                             httplibuse,
                                                                             1,
                                                                             [0,
                                                                              numoflinks]),
                                   'created': get_motherless_galleries_links("http://motherless.com/galleries/created",
                                                                             httpheaders,
                                                                             httpcookie,
                                                                             httplibuse,
                                                                             1,
                                                                             [0,
                                                                              numoflinks]),
                                   'viewed': get_motherless_galleries_links("http://motherless.com/galleries/viewed",
                                                                            httpheaders,
                                                                            httpcookie,
                                                                            httplibuse,
                                                                            1,
                                                                            [0,
                                                                             numoflinks]),
                                   'favorited': get_motherless_galleries_links("http://motherless.com/galleries/favorited",
                                                                               httpheaders,
                                                                               httpcookie,
                                                                               httplibuse,
                                                                               1,
                                                                               [0,
                                                                                numoflinks]),
                                   'commented': get_motherless_galleries_links("http://motherless.com/galleries/commented",
                                                                               httpheaders,
                                                                               httpcookie,
                                                                               httplibuse,
                                                                               1,
                                                                               [0,
                                                                                numoflinks])}}
    if (urltype == "all" and enablerand):
        returnval = {'numoflinks': numoflinks,
                     'orginurl': "http://motherless.com/",
                     'orginurltype': get_motherless_link_type("http://motherless.com/"),
                     'videos': {'recent': get_motherless_galleries_links("http://motherless.com/videos/recent",
                                                                         httpheaders,
                                                                         httpcookie,
                                                                         httplibuse,
...
def get_motherless_link_by_type(
    httpurl, httpheaders, httpcookie, httplibuse="urllib", page=1, getlinks=[
        0, -1], motherless_serv=None):
    httpurl = fix_motherless_url(httpurl)
    returnval = False
    if (get_motherless_link_type(httpurl) == "link"):
        returnval = get_motherless_links(
            httpurl, httpheaders, httpcookie, httplibuse, motherless_serv)
    if (get_motherless_link_type(httpurl) == "gallery"):
        returnval = get_motherless_galleries_links(
            httpurl,
            httpheaders,
            httpcookie,
            httplibuse,
    ...
    if (get_motherless_link_type(httpurl) == "sample-videos"):
        returnval = get_motherless_sample_links(
            httpheaders, httpcookie, httplibuse, 10, "video")
    if (get_motherless_link_type(httpurl) == "sample-images"):
        returnval = get_motherless_sample_links(
            httpheaders, httpcookie, httplibuse, 10, "image")
    if (get_motherless_link_type(httpurl) == "sample-galleries"):
        returnval = get_motherless_sample_links(
            httpheaders, httpcookie, httplibuse, 10, "gallery")
    if (get_motherless_link_type(httpurl) ==
            "sample" or get_motherless_link_type(httpurl) == "sample-all"):
        returnval = get_motherless_sample_links(
            httpheaders, httpcookie, httplibuse, 10, "all")
    if (get_motherless_link_type(httpurl) == "board"):
        returnval = get_motherless_boards_links(
            httpurl,
            httpheaders,
            httpcookie,
            httplibuse,
            ...
            motherless_serv)
    if (get_motherless_link_type(httpurl) == "member"):
        returnval = get_motherless_search_members(
            httpurl, httpheaders, httpcookie, httplibuse, page, getlinks)
    if (get_motherless_link_type(httpurl) == "girls"):
        returnval = get_motherless_girls(
            httpheaders, httpcookie, httplibuse, getlinks)
    if (get_motherless_link_type(httpurl) == "download"):
        returnval = get_motherless_links_from_url(
            httpurl, httpheaders, httpcookie, httplibuse)
    return returnval


def view_motherless_links(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib",
...
def download_motherless_links(
    ...
    if (usetitlename == "-" and not outfile == "-"):
        outputname = outfile
    returnval = download_from_url_to_file(
        mlessurl['url'],
        httpheaders,
        httpcookie,
        httplibuse,
...
def download_motherless_links_by_type(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib",
    ...
    if (sleep < 0):
        sleep = geturls_download_sleep
    mlessurl = get_motherless_link_by_type(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse,
...
def download_motherless_galleries_links(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib",
    ...
    if (sleep < 0):
        sleep = geturls_download_sleep
    mlessgalleries = get_motherless_galleries_links(
        httpurl, httpheaders, httpcookie, httplibuse, page, getlinks, motherless_serv)
    mli = 0
    ...
    returnval.update({'orginurltype': get_motherless_link_type(httpurl)})
    while (mli < mlil):
        mlesslink = get_motherless_links(
            mlessgalleries[mli]['url'], httpheaders, httpcookie, httplibuse)
        ...
        returnval.update(
            {
                mli: {
                    'download': download_from_url_to_file(
                        mlesslink['url'],
                        httpheaders,
                        httpcookie,
                        httplibuse,
...
def download_motherless_boards_links(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse="urllib",
    ...
    if (sleep < 0):
        sleep = geturls_download_sleep
    mlessgalleries = get_motherless_boards_links(
        httpurl,
        httpheaders,
        httpcookie,
        httplibuse,
